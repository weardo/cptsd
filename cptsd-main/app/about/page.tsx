    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex items-center gap-3 mb-8">
        <Image
          ...
          className="h-12 w-12"
        />
        <h1 className="text-4xl font-bold text-on-surface">About CPTSD.in</h1>
      </div>

      <div className="prose prose-lg max-w-none">
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-on-surface mb-4">Who we are</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-on-surface mb-4">What we do</h2>
          <p className="text-on-surface text-lg leading-relaxed mb-4">We work to:</p>
          <ul className="list-disc pl-6 space-y-2 text-on-surface text-lg">
        ...
        <section className="mb-12 bg-surface-container-high border-l-4 border-primary-container p-6 rounded-xl">
          <h2 className="text-2xl font-bold text-on-surface mb-4">What we cannot do</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-on-surface mb-4">Our values</h2>
          <ul className="space-y-3 text-on-surface text-lg">
            <li className="flex items-start">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-on-surface mb-4">Contact & Support</h2>
          <p className="text-on-surface text-lg leading-relaxed mb-4">
