...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-4xl font-bold text-on-surface mb-8">Terms & Conditions</h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-on-surface mb-4">Use of Website</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-on-surface mb-4">External Links</h2>
          <p className="text-on-surface text-lg leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-on-surface mb-4">Community Stories</h2>
          <p className="text-on-surface text-lg leading-relaxed mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-on-surface mb-4">Content Moderation</h2>
          <p className="text-on-surface text-lg leading-relaxed">
        ...
        <section className="mb-12 bg-surface-container-low border-l-4 border-primary p-6 rounded-xl">
          <h2 className="text-2xl font-bold text-on-surface mb-4">Emergency Services</h2>
          <p className="text-on-surface text-lg leading-relaxed">
