	...
	return (
		<main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 space-y-10">
			<section className="max-w-3xl">
				<h1 className="text-4xl font-bold text-on-surface">Mental Health Professionals Directory</h1>
				...
				<div className="mt-4 bg-surface-container-high border-l-4 border-primary-container p-4 rounded-xl">
