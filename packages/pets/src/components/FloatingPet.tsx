...
export default function FloatingPet({
  ...
  // Extract pet color from SVG or use default
  const petColor = useMemo(() => {
    ...
    return colorMap[petType] || '#d4a5c7';
  }, [petType]);
  ...
  return (
    ...
    >
      {/* Pet sprite rendered first (lower z-index) */}
      <div
      ...
      {/* Speech bubble rendered after sprite (higher z-index, appears above) */}
      {showBubble && currentMessage && (
        <SpeechBubble message={currentMessage} position="bottom" petColor={petColor} />
      )}
